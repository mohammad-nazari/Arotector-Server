...
namespace Options {
    ...
    inline NewDataSet::NewDataSet() {
        this->BeginInit();
        this->InitClass();
        ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &Options::NewDataSet::SchemaChanged);
    ...
    inline NewDataSet::NewDataSet(::System::Runtime::Serialization::SerializationInfo^  info, ::System::Runtime::Serialization::StreamingContext context) : 
        ...
        if (this->IsBinarySerialized(info, context) == true) {
            this->InitVars(false);
            ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler1 = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &Options::NewDataSet::SchemaChanged);
    ...
    inline ::System::Data::DataSet^  NewDataSet::Clone() {
        Options::NewDataSet^  cln = (cli::safe_cast<Options::NewDataSet^  >(__super::Clone()));
        cln->InitVars();
    ...
    inline ::System::Xml::Schema::XmlSchemaComplexType^  NewDataSet::GetTypedDataSetSchema(::System::Xml::Schema::XmlSchemaSet^  xs) {
        Options::NewDataSet^  ds = (gcnew Options::NewDataSet());
