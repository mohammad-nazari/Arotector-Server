...
class ns__DataBaseInfo;	/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:16 */
class ns__ServerOptions;	/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:24 */

/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:16 */
#ifndef SOAP_TYPE_ns__DataBaseInfo
#define SOAP_TYPE_ns__DataBaseInfo (15)
/* ns:DataBaseInfo complex type: */
class SOAP_CMAC ns__DataBaseInfo
{
public:
	std::string dataBaseInfoServerName;	/* required element of XSD type xsd:string */
	int dataBaseInfoPort;	/* required element of XSD type xsd:int */
	std::string dataBaseInfoUserName;	/* required element of XSD type xsd:string */
	std::string dataBaseInfoPassWord;	/* required element of XSD type xsd:string */
public:
	/// Return the unique type ID value SOAP_TYPE_ns__DataBaseInfo (15)
...
/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:24 */
#ifndef SOAP_TYPE_ns__ServerOptions
#define SOAP_TYPE_ns__ServerOptions (16)
/* ns:ServerOptions complex type: */
class SOAP_CMAC ns__ServerOptions
{
public:
	ns__DataBaseInfo optionsDataBaseInfo;	/* required element of XSD type ns:DataBaseInfo */
	int optionsTimeRepeat;	/* required element of XSD type xsd:int */
public:
	/// Return the unique type ID value SOAP_TYPE_ns__ServerOptions (16)
...
/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:29 */
...
/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:7 */
...
/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:11 */
#ifndef SOAP_TYPE_xsd__string
#define SOAP_TYPE_xsd__string (9)
typedef std::string xsd__string;
#endif

/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:12 */
#ifndef SOAP_TYPE_xsd__int
#define SOAP_TYPE_xsd__int (10)
typedef int xsd__int;
#endif

/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:13 */
#ifndef SOAP_TYPE_xsd__bool
#define SOAP_TYPE_xsd__bool (12)
typedef bool xsd__bool;
#endif

/* F:\Projects\WebService\GeneratedCode\Protector\source\DataBinding\source.h:14 */
