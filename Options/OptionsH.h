...
#define soap_write_xsd__bool(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || soap_put_xsd__bool(soap, data, "xsd:bool", NULL) || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 bool * SOAP_FMAC4 soap_get_xsd__bool(struct soap*, bool *, const char*, const char*);

#ifndef soap_read_xsd__bool
#define soap_read_xsd__bool(soap, data) ( ((data) ? (soap_default_xsd__bool(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_xsd__bool(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
